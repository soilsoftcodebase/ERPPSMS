...
export default function AlertManagement() {
  ...
  // New state for system setup role selection
  const [setupSelectedRole, setSetupSelectedRole] = useState<string>('');
        ...
        {showSystemSetup && (
          <div className="mb-4 p-4 bg-white rounded-lg shadow transition-all">
            <div className="mb-4">
              ...
              <input
                type="file"
                className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:border file:rounded-md file:border-gray-300 file:text-sm file:font-semibold file:bg-gray-50 hover:file:bg-gray-100"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700">
              ...
              <select
                value={setupSelectedRole}
                onChange={e => setSetupSelectedRole(e.target.value)}
                className="block w-full p-2 border border-gray-300 rounded-md"
              >
                <option value="">Select a role</option>
                {availableRoles.map(role => (
