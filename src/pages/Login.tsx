...
export default function Login() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-10"
      style={{
        backgroundImage: `url(${LSMSbg})`, // Adjust the path
    ...
    >
      <div className="min-h-screen flex flex-col py-12 sm:px-6 lg:px-8">
        <div className="">
          ...
          <img src={PSMSLogo} alt="PSMS Logo" className="w-[450px] ml-10 " />
        </div>
        <div className="flex-grow flex flex-col justify-center ml-[800px] relative bottom-56">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md ">
            <div className="bg-white py-8 px-4 shadow-2xl shadow-gray-100/10 sm:rounded-lg sm:px-10">
              <h2 className="mt-6 text-center text-3xl font-bold text-gray-700 mb-4">
                SIGN IN
              </h2>
              {error && (
